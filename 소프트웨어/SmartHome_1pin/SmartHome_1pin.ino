...
#include <DHT11.h>
//-----Publish 토픽1
#define __Pub_TOPIC1__ "/Room/Kitchen/RE1"

//-----Publish 토픽 DHT11 온도
#define __Pub_DHT11_TM_TOPIC2__ "/Room/Kitchen/TM"
//-----Publish 토픽 DHT11 습도
#define __Pub_DHT11_HU_TOPIC2__ "/Room/Kitchen/HU"

//-----Subscribe 토픽
#define __Sub_TOPIC__ "/Room/Kitchen"

//-----모듈 넘버
#define __Client_Name__ "ESP_Room_Kitchen"
...
void loop() {
  ...
  if (Timer_DHT11 < millis()) {
    ...
    if ((err = dht11.read(humi, temp)) == 0) {
      Serial.print((int)humi);//asdfasdf
      Serial.print(", ");
      Serial.println(temp);//asdfasdf
